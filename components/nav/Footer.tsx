...
const linkClass =
  'inline-flex items-center min-h-11 text-paper/80 hover:text-marmalade hover:underline rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-marmalade'
